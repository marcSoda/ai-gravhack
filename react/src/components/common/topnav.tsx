...
const NavItem: React.FC<NavItemProps> = (props) => {
    ...
    const commonProps = {
        ...
        onMouseOver: (e: React.MouseEvent) => (e.currentTarget as HTMLElement).style.backgroundColor = '#4B5563',
        onMouseOut: (e: React.MouseEvent) => (e.currentTarget as HTMLElement).style.backgroundColor = 'transparent',
    };
