  ...
  return (
    <div style={{ padding: "16px 40px" }}>
      ...
      <div style={{ paddingTop: 16 }}>
        ShadowbaseAI chat is an expert in all things Shadowbase. Consider it to
        be your personal Shadowbase assistant that can help answer your
        questions by combing through a repository of manuals, documentation,
        training data, and publications.
        <Title>Use Cases</Title>
        <ul>
          <li>
            Quickly summarize relevant search results across Shadowbase content
          </li>
        ...
        <p>
          ...
          answers, but since the data spans a variety of sources, some responses
          may not be 100% accurate specific to the your environment.
        </p>
      </div>
    </div>
  );
